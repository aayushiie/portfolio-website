...
export default function Writing() {
  ...
  text={
    <>
      i have been writing little pieces of fiction since 2017, when i was in
      middle school. i only began taking it seriously after graduating high school in
      2022. since then, i've worked with youth-led magazines as a{" "}
      <NavLink
        to="/about"
      ...
      of my own with friends, and maintained a small{" "}
      <a
      ...
      for thoughts, stories, and niche technical content.
    </>
  }
/>
    ...
    <section className="w-full px-20 py-20 font-space">
      ...
      >
        <h2 className="border-b-4
          border-[#f8f6f3] mx-4">Title</h2>
        <h2 className="border-b-4
          border-[#f8f6f3] mx-4">Published In</h2>
        <h2 className="border-b-4
          border-[#f8f6f3] mx-4">Date</h2>
        <h2 className="border-b-4
          border-[#f8f6f3] mx-4">Category</h2>
      </div>
